...
class TestPortScannerIntegration:
    ...
    def test_port_check_result_structure(self):
        ...
        result = PortCheckResult(host="localhost", port=80, status=PortStatus.OPEN, service_name="HTTP", response_time_ms=5.0)
...
class TestPortScannerPhase3Integration:
    ...
    def test_summarize_port_scan_result_structure(self):
        ...
        from shared.port_utils import PortCheckResult, PortStatus, summarize_port_scan
